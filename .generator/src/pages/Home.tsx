    ...
    <Layout title="SSUFID - 숭실대학교 공지사항 피드">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="mb-8 text-center text-gray-600 dark:text-gray-400">
          숭실대학교 공지사항과 학사일정을 빠르게 피드로 확인하세요
        </p>
        ...
        <div className="mb-8 rounded-lg border border-blue-200 bg-blue-50 p-6 dark:border-blue-900 dark:bg-blue-950/30">
          ...
          <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
            SSUFID가 배포하는 JSON, RSS, iCalendar feed와 sites.json index를 Scalar 기반 문서로 확인하세요.
          </p>
            ...
            {sites.map((site) => (
              ...
              >
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-blue-600 dark:text-blue-400">항목 {site.itemCount}개</span>
